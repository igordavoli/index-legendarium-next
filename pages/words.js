			...
			>
				...
				{screenState === screenStates.SEARCH_RESULT && (
					...
					>
						...
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse iaculis, metus gravida pretium aliquam, sem quam accumsan metus, a posuere urna enim viverra nibh. Integer quis metus varius, egestas mauris a, viverra eros. Phasellus et sem sit amet tortor faucibus tempus vel vitae sem.</p>


						<div className="word-options">
							<div className="share" alt="Compartilhar" title="Compartilhar">
								<svg  x="0px" y="0px" viewBox="0 0 227.216 227.216" >
